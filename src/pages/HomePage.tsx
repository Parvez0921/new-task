      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h2 className="max-w-2xl text-4xl font-semibold leading-tight text-white sm:text-5xl">
            A React + TypeScript foundation with routing and Tailwind already in
            place.
          </h2>
          <p className="max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
            The root layout lives in{" "}
            <code className="rounded bg-white/10 px-2 py-1 text-sm text-cyan-200">
              App.tsx
            </code>{" "}
            and renders an{" "}
            <code className="rounded bg-white/10 px-2 py-1 text-sm text-cyan-200">
            ...
            so you can drop in nested pages next.
          </p>
        </div>
      </div>

      <div className="rounded-xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-cyan-950/30 backdrop-blur">
